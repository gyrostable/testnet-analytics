...
'''Pick startblock and endblock parameters for API query'''
startblock=23504282
endblock=25000000

'''Direct all_addresses to list of addresses we want to consider'''
all_addresses = pd.read_csv("export-tokenholders-for-contract-0xd0474aEBA181987A81352842d446Fc6c65481417.csv")['HolderAddress']
...
def eth_url(module, action, address):
    ...
    return 'http://api-kovan.etherscan.io/api?module={}&action={}&address={}&startblock={}&endblock={}&sort=asc'.format(module, action, address, startblock, endblock)
...
with open('bot_addresses.csv','w') as f:
